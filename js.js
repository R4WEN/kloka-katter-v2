...
/* function pageElements() {
    addButton('meow', 'print-button', printQuote); // button text, button ID, function for event listener
...
// ########################################################################################
// ########################################################################################
// ######################### sätt båda knapparna till att öppna ###############################################################
// ########################## guru.html och kalla funktioner med ##############################################################
// ########################### respektive bild-api som argument #############################################################
// plus ändra text i knapparna meow och woff?
// plus kunna gå tillbaks till startsida (.innerhtml så ist för choose your being står det något skoj)

// https://stackoverflow.com/questions/27674425/how-to-open-another-html-page-using-javascript
document.getElementById("button-cat").addEventListener("click", function() {
 ...
 */
document.getElementById("button-quote").addEventListener("click", printQuote);
